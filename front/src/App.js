...
render(){
  ...
  else if(this.state.isCorrect === true && this.state.projectStatus === 'create' && this.state.loggedPersonType === 'STUDENT')
  {
    return (    <div>
      ...
      <br/>
      <div style={{backgroundColor: 'rgba(204, 153, 0, 0.7)',
        borderRadius: '25px', border: 'solid 3px rgb(76, 80, 80)', maxWidth:'40%', margin: '0 auto'}}>
      <div style={{fontFamily:'Consolas',fontSize:16,fontWeight:'bold',marginTop:'10px',textAlign:'center'}}>TEAM MEMBERS: </div>
      <br/>
      <ol style={{fontFamily:'Consolas',fontSize:16,fontWeight:'bold',marginTop:'10px',width:'300px',textAlign:'center', display:'table', margin:'0 auto'}}>
        {listaEchipa.map(e=><li onMouseOver="this.style.color='#cc9900'"><Person item={e} key={e.id}/></li>)}
      </ol>
      <br/>
      <div style={{maxWidth:'40%',margin: '0 auto'}}>
      <Select style={{maxWidth:'40%'}} name="membriiAditionali" id="membriiAditionali"  options={listaMembrii} onChange={this.selectieMembruEchipa}></Select>
      </div>
      <br/>
  ...
  else if(this.state.isCorrect === true && this.state.projectStatus === 'myProjects' && this.state.loggedPersonType === 'STUDENT' && this.state.selected !== -1)
  {
    return (    
    <div>
      <div style={{fontFamily:'Consolas',fontSize:22,fontWeight:'bold',fontStyle:'italic',marginTop:'10px', textAlign:'center'}}>
      <StudentProjectList onCreateProject={this.createProject} onMyProjects={this.myProjects} onGradeProjects={this.gradeProjects}/>
      <br/><br/>
      ...
      <div style={{fontFamily:'Consolas',fontSize:16,fontWeight:'bold',marginTop:'10px',textAlign:'center'}}>PROJECTS </div>
